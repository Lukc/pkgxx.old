...
#include "checks.sh"
#include "includes.sh"
#include "downloads.sh"
#include "unpack.sh"
#include "checksums.sh"
#include "footprints.sh"
#include "strip.sh"
#include "manpages.sh"
#include "work.sh"
#include "interactions.sh"
#include "splits.sh"
#include "signatures.sh"
#include "build.sh"
#include "install.sh"
#include "opts.sh"
#include "clean.sh"
#include "recursive.sh"
...
PKGMK_DEFAULTS_DIRS=("@SHAREDIR@/pkg++/defaults" "@SYSCONFDIR@/pkg++/defaults/")
# Post-recipe defaults.
PKGMK_PRDEFAULTS_DIRS=("@SHAREDIR@/pkg++/post-defaults" "@SYSCONFDIR@/pkg++/post-defaults/")
PKGMK_INCLUDES_DIR="@SHAREDIR@/pkg++/includes"
PKGMK_MODULES_DIR="@SHAREDIR@/pkg++/modules"
PKGMK_PROFILES_DIRS=("@SHAREDIR@/pkg++/profiles" "@SYSCONFDIR@/pkg++/profiles")
PKGMK_LOCALES_DIR="@SHAREDIR@/pkg++/locales"
